...
/***/ function(module, exports, __webpack_require__) {
	...
	router.beforeEach(function (_ref) {
	  ...
	  _store2.default.dispatch('UPDATE_PATH', to.path);
	  next();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/demos/app.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	  UPDATE_PATH: function UPDATE_PATH(state, path) {
	    state.path = path;
	  },
	  ADD_DEMOS: function ADD_DEMOS(state, demo) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  data: function data() {
	    return {
	      date: _2.default.date()
	    };
	  },

	  methods: {
	    getDate: function getDate() {
	      this.date = _2.default.date();
	    }
	  }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	for (var key in _check2.default) {
	  exports[key] = _check2.default[key];
	}
...
/***/ function(module, exports) {
	...
	var webReg = /appleWebKit.*mobile.*/i;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./check.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./check.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  data: function data() {
	    return {
	      isWx: _2.default.isWx(),
	      isWeb: _2.default.isWeb()
	    };
	  }
	};
	// </script>
